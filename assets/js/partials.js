...
<header class="navbar">
  <div class="container">
    ...
    <a href="{{R}}index.html" class="logo">
      <img src="{{R}}assets/images/logo.svg" alt="WINWINIT logo" width="38" height="38">
    ...
    <nav class="nav-menu">
      ...
      <div class="nav-item has-dropdown">
        ...
        <div class="dropdown-menu">
          <a href="{{R}}wordpress-service.html">WordPress Website</a>
          <a href="{{R}}shopify-service.html">Shopify Store</a>
          <a href="{{R}}woocommerce-service.html">WooCommerce Store</a>
          <a href="{{R}}ecommerce-service.html">Ecommerce Website</a>
          <a href="{{R}}graphics-service.html">Graphics Design</a>
        </div>
      </div>
      <a href="{{R}}packages.html">Packages</a>
      <div class="nav-item has-dropdown">
        <a href="{{R}}portfolio.html">Portfolio</a>
        <div class="dropdown-menu">
          <a href="{{R}}portfolio.html#projects">Projects</a>
          <a href="{{R}}portfolio.html#case-studies">Case Studies</a>
        </div>
      </div>
      <div class="nav-item has-dropdown">
        <a href="{{R}}blog.html">Blog</a>
        <div class="dropdown-menu">
          <a href="{{R}}blog.html#latest">Latest Posts</a>
          <a href="{{R}}blog.html#categories">Categories</a>
        </div>
      </div>
    ...
    <div class="nav-actions">
      ...
      <a href="{{R}}contact.html" class="btn btn-primary">Get In Touch →</a>
    </div>
  </div>
</header>
...
<footer class="footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul class="footer-links">
          ...
          <li><a href="{{R}}global-reach.html">Where We Work</a></li>
      ...
      <div>
        <h4>Services</h4>
        <ul class="footer-links">
          <li><a href="{{R}}wordpress-service.html">WordPress Development</a></li>
          <li><a href="{{R}}shopify-service.html">Shopify Stores</a></li>
          <li><a href="{{R}}woocommerce-service.html">WooCommerce Stores</a></li>
          <li><a href="{{R}}ecommerce-service.html">Ecommerce Websites</a></li>
          <li><a href="{{R}}graphics-service.html">Graphics Design</a></li>
        </ul>
      </div>
      <div>
        <h4>Contact Us</h4>
    ...
    <div class="footer-bottom">
      ...
      <span><a href="{{R}}privacy-policy.html">Privacy Policy</a> · <a href="{{R}}terms-conditions.html">Terms &amp; Conditions</a> · <a href="{{R}}cookie-policy.html">Cookie Policy</a> · <a href="{{R}}money-back-guarantee.html">Money-Back Guarantee</a></span>
    </div>
  </div>
</footer>
`;
...
<a href="https://wa.me/8801849620018" class="whatsapp-button" target="_blank" rel="noopener" aria-label="Chat with us on WhatsApp">
...
var GLOBE_BG_HTML = '<iframe src="{{R}}bangladesh_globe_offline_google.html" class="site-globe-frame" title="Interactive offline Bangladesh globe background" loading="lazy" aria-hidden="true"></iframe>';

(function () {
  var headerSlot = document.getElementById('site-header');
  var footerSlot = document.getElementById('site-footer');
  var root = (headerSlot && headerSlot.getAttribute('data-root')) || (footerSlot && footerSlot.getAttribute('data-root')) || '';
  if (root && root.slice(-1) !== '/') root += '/';

  var headerHtml = SITE_HEADER_HTML.split('{{R}}').join(root);
  var footerHtml = SITE_FOOTER_HTML.split('{{R}}').join(root);
  var globeHtml = GLOBE_BG_HTML.split('{{R}}').join(root);

  if (headerSlot) headerSlot.innerHTML = headerHtml;
  if (footerSlot) footerSlot.innerHTML = footerHtml;

  var savedTheme = localStorage.getItem('winwinit-theme');
  ...
  if (themeToggle) {
    themeToggle.addEventListener('click', function () {
      ...
      if (isDark) {
        ...
        localStorage.setItem('winwinit-theme', 'light');
      } else {
        document.documentElement.setAttribute('data-theme', 'dark');
        localStorage.setItem('winwinit-theme', 'dark');
      }
    });
  }
